/* Companion stub for string.exl.  Wires the prelude Allocator to
 * libc malloc/free — same shape as allocator_demo_stub.c and
 * string_builder_stub.c, repeated for the one-feature-one-file rule. */
