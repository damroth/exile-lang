/* Companion stub for arm_generic_payload.exl — the same libc-malloc bridge the
 * other allocator-using fixtures in this directory carry, repeated per the
 * one-feature-one-file rule rather than shared. */
